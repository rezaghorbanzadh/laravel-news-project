...
<script src="{{asset("assets/Home/js/easing.min.js")}}"></script>
<script src="{{asset("assets/Home/js/hoverIntent.js")}}"></script>
<script src="{{asset("assets/Home/js/superfish.min.js")}}"></script>
...
<script src="{{asset("assets/Home/js/mn-accordion.js")}}"></script>
